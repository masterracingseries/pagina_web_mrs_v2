...
const Champions: React.FC = () => {
  ...
  const allChampions = config.campeones;

  // Extraer temporadas únicas disponibles, ordenadas de más reciente a más antigua
  const availableSeasons = [...new Set(allChampions.map(c => c.season))]
    .sort((a, b) => {
  ...
  const filteredChampions = activeTab === 'ALL'
    ? allChampions
    : allChampions.filter(c => c.season === activeTab);
    ...
    <section id="champions" className="py-24 bg-gradient-to-b from-mrs-black to-gray-900 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-16">
          ...
          {/* Botones generados dinámicamente desde los campeones en GCS */}
        ...
        <div className="min-h-[500px]">
          {activeTab === 'ALL' ? (
            <div className="relative w-full overflow-hidden">
              ...
              >
                {[...allChampions, ...allChampions].map((champ, index) => (
