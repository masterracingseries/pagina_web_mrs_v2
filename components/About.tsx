              ...
              <div className="bg-gray-900/50 backdrop-blur-sm rounded-[2rem] p-10 border border-white/5 hover:border-mrs-yellow/30 transition-all duration-500 shadow-2xl h-full flex flex-col items-center text-center">
                ...
                <div className="mt-4 mb-6">
                  <h4 className="text-3xl font-display italic tracking-tighter text-white mb-2 group-hover:text-mrs-yellow transition-colors uppercase">
                    ...
                    <span className="text-mrs-yellow group-hover:text-white transition-colors">{admin.name.split(' ').slice(1).join(' ')}</span>
                  </h4>
                ...
                <div className="mt-auto pt-8 flex gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <a href={social.instagram} className="text-gray-500 hover:text-white transition-colors"><Instagram size={20} /></a>
                  <a href={social.twitch} className="text-gray-500 hover:text-white transition-colors"><Twitch size={20} /></a>
                </div>
              </div>
            </motion.div>
          ))}
        ...
        <div className="mt-24 flex justify-center">
          <div className="flex gap-8 items-center bg-gray-900/80 px-10 py-6 rounded-full border border-white/5 backdrop-blur-md">
            ...
            <div className="flex gap-6">
              <a href={social.instagram} target="_blank" rel="noreferrer" className="text-white hover:text-mrs-red transition-all hover:scale-125"><Instagram size={24} /></a>
              <a href={social.twitch}    target="_blank" rel="noreferrer" className="text-white hover:text-purple-500 transition-all hover:scale-125"><Twitch size={24} /></a>
              <a href={social.youtube}   target="_blank" rel="noreferrer" className="text-white hover:text-red-600 transition-all hover:scale-125"><Youtube size={24} /></a>
            </div>
          </div>
        </div>
      </div>
